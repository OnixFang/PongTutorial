...
public class GameSetup : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        //Place Players
        Player01.position = new Vector2(mainCam.ScreenToWorldPoint(new Vector3(40f, 0f, 0f)).x, 0f);
        Player02.position = new Vector2(mainCam.ScreenToWorldPoint(new Vector3(Screen.width - 40f, 0f, 0f)).x, 0f);
    }
}